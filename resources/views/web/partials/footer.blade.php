		<!-- Footer Section -->
			<footer class="footer inner-footer footer-info">
				<div class="footer-top">
					...
					<div class="footer-bg">
						<img src="{{ asset('assets/img/bg/footer-bg-01.png')}}" alt="img" class="footer-bg-01">
						<img src="{{ asset('assets/img/bg/footer-bg-02.png')}}" alt="img" class="footer-bg-02">
						<img src="{{ asset('assets/img/bg/footer-bg-03.png')}}" alt="img" class="footer-bg-03">
						<img src="{{ asset('assets/img/bg/footer-bg-04.png')}}" alt="img" class="footer-bg-04">
						<img src="{{ asset('assets/img/bg/footer-bg-05.png')}}" alt="img" class="footer-bg-05">
					</div>
				</div>
					...
					<div class="container">
						...
						<div class="copyright">
							...
							<ul class="payment-method">
								<li><a href="javascript:void(0);"><img src="{{ asset('assets/img/icons/card-01.svg')}}" alt="Img"></a></li>
								<li><a href="javascript:void(0);"><img src="{{ asset('assets/img/icons/card-02.svg')}}" alt="Img"></a></li>
								<li><a href="javascript:void(0);"><img src="{{ asset('assets/img/icons/card-03.svg')}}" alt="Img"></a></li>
								<li><a href="javascript:void(0);"><img src="{{ asset('assets/img/icons/card-04.svg')}}" alt="Img"></a></li>
								<li><a href="javascript:void(0);"><img src="{{ asset('assets/img/icons/card-05.svg')}}" alt="Img"></a></li>
								<li><a href="javascript:void(0);"><img src="{{ asset('assets/img/icons/card-06.svg')}}" alt="Img"></a></li>
							</ul>
						</div>
						<!-- /Copyright -->
					</div>
